...
<!-- Sidenav -->
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="{{ url('/newhome') }}">
        <img src="./images/hmm.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/newhome') }}">
  ...
  <div class="main-content">
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-md-8" style="background-color: #000119">
      <div class="container-fluid">
